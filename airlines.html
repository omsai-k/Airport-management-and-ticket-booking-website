...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <section id="section1">
        <div class="container">
            ...
            <?php
            // SQL query to retrieve data from the "airlines" table
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<table><tr><th>Airline Name</th><th>No. of Planes</th><th>No. of Pilots</th></tr>";

                // Output data of each row
                while ($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["airline_name"] . "</td><td>" . $row["no_of_planes"] . "</td><td>" . $row["no_of_pilots"] . "</td></tr>";
                }
